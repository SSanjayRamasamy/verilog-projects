...
## Switches
set_property -dict { PACKAGE_PIN W19 IOSTANDARD LVCMOS33 } [get_ports { rst }];#LSB
...
##7 segment display
set_property -dict { PACKAGE_PIN T11 IOSTANDARD LVCMOS33 } [get_ports {seg_en[3]}]; #LSB
set_property -dict { PACKAGE_PIN T10 IOSTANDARD LVCMOS33 } [get_ports {seg_en[2]}];
set_property -dict { PACKAGE_PIN T12 IOSTANDARD LVCMOS33 } [get_ports {seg_en[1]}];
set_property -dict { PACKAGE_PIN U12 IOSTANDARD LVCMOS33 } [get_ports {seg_en[0]}];#MSB
...
set_property -dict { PACKAGE_PIN Y16 IOSTANDARD LVCMOS33 } [get_ports {dot}];#DP
...
#set_property -dict { PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports {signal}];
set_property -dict { PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports {async_in}];
#set_property -dict { PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {signal2}]; 
